...
- full workflow/pipeline description, including: the main entrypoint; what is trained and based on which inputs, data, and configuration; how the pipeline is executed; where results are saved (output directory)
- how to run end-to-end experiments that fulfill the project plan
- assumptions, limitations, and intended usage boundaries of the system
